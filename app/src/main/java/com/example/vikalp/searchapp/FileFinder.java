 ...
 * @author Vikalp
 *
 * FileFinder class -- provides file searching functions in the internal storage of phone
 */
...
public class FileFinder {
    ...
    private static FileFinder fileFinderObj;
     ...
     * singleton design method to get instance
      */
    public static FileFinder getObject(){
        if (fileFinderObj == null) {
            fileFinderObj = new FileFinder();
